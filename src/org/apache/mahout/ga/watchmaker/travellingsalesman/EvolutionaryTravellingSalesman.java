  ...
  private EvolutionEngine<List<String>> getEngine(CandidateFactory<List<String>> candidateFactory,
    ...
    if (mahout) {
      ...
      FitnessEvaluator<? super List<String>> evaluator = new MahoutFitnessEvaluator<List<String>>(
          new NRouteEvaluator(distances));
      // Then use a GenerationalEvolutionEngine.
      GenerationalEvolutionEngine<List<String>> engine = new GenerationalEvolutionEngine<List<String>>(candidateFactory, pipeline, evaluator,
