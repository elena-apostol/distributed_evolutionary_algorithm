 ...
 * @author Daniel Dyer
 */
public class ArrayListOrderMutation<T> implements EvolutionaryOperator<ArrayList<T>>
{
     ...
     */
    public ArrayListOrderMutation(int mutationCount, int mutationAmount)
    {
     ...
     */
    public ArrayListOrderMutation(NumberGenerator<Integer> mutationCount,
    ...
    public List<ArrayList<T>> apply(List<ArrayList<T>> selectedCandidates, Random rng)
    {
