 ...
 * @author Daniel Dyer
 */
public class ArrayListOrderCrossover<T> extends AbstractCrossover<ArrayList<T>>
{
    /**
     * Creates a cross-over operator with a cross-over probability of 1.
     */
    public ArrayListOrderCrossover()
    {
     ...
     * for any given pair.
     */
    public ArrayListOrderCrossover(Probability crossoverProbability)
    {
     ...
     */
    public ArrayListOrderCrossover(NumberGenerator<Probability> crossoverProbabilityVariable)
    {
                                       ...
                                       int mappingEnd)
    {
        for (int i = 0; i < offspring.size(); i++)
        {
            if (!isInsideMappedRegion(i, mappingStart, mappingEnd))
            {
                ...
                {
                	System.out.println("1.1..................." + mapped + " - " + mapping);
